...
sudo pacman -S --needed vim git fzf fish ffmpeg fuse2 libdecor libnotify grim slurp earlyoom cliphist
...
sudo pacman -S --needed geoclue gst-plugin-pipewire gst-
plugin-qsv gst-plugins-bad gst-plugins-base gst-plugins-good gst-p
lugins-ugly gstreamer-vaapi
